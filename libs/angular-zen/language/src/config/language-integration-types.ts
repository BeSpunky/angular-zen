...
/** Represents a translation functino that receives a value (typically a translation id) and translation params, then returns the translation in the current language. */
