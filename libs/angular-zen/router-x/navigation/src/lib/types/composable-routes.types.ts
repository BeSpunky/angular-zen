...
import type { CombinedPath, RoutePathSegment, RouteSegments } from './route-paths.types';

export interface ReadonlyRoute<
    PathSegment extends RoutePathSegment,
    FriendlyName extends string,
    Children extends DeepReadonlyRouteChildren | undefined> extends Readonly<Omit<Route, 'path' | 'children'>
>
{
    /**
...
export type ComposableRoutesArray<RouteArray, Entity, Root extends string> =
    RouteArray extends readonly [
        infer First extends ReadonlyRoute<infer Segment, string, any>,
        ...infer Rest
    ]
    ? readonly [
...
export type ComposableRoute<Route extends ReadonlyRoute<RoutePathSegment, string, DeepReadonlyRouteChildren | undefined>, Entity, Root extends string> =
